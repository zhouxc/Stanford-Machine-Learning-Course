...
from hmm import HMM
from viterbi import run_viterbi, train_hmm_from_data
from classify import (
    compute_classification_performance,
    split_into_categories,
    train_N_state_hmms_from_data,
)
...
class Robot(tftask.ChartTask):
    ...
    def get_name(self):
        return "Robot experiments -- what path did the robot take to "
    "see these sequences of colors?"

    def get_priority(self):
        return 1

    def get_description(self):
        return ("Train an HMM for each robot condition,"
...
class WeatherStates_boston_la(tftask.ChartTask):
    ...
    def get_name(self):
        return "1st Weather experiments -- which city has"
    " this weather, boston or LA?"

    def get_priority(self):
        return 2

    def get_description(self):
        return ("Train HMMs with different number of hidden states,"
                " and see how well they can distinguish between"
                "the weather of different cities.")
    ...
    def task(self):
        ...
        chart = {"chart": {"defaultSeriesType": "line"},
                 ...
                 "yAxis": {"title": {"text": "Fraction Correct"},
                           "min": 0.0, "max": 1.0},
                 "title": {"text": "HMM performance "
                           "on classifying weather sequences by city"},
...
class WeatherStates_boston_seattle(tftask.ChartTask):
    ...
    def get_name(self):
        return "2nd Weather experiments -- which city has"
    " this weather, boston or seattle?"

    def get_priority(self):
        return 3

    def get_description(self):
        return ("Train HMMs with different number of hidden states, and "
                "see how well they can distinguish between"
                " the weather of different cities.")
    ...
    def task(self):
        ...
        chart = {"chart": {"defaultSeriesType": "line"},
                 ...
                 "yAxis": {"title": {"text": "Fraction Correct"},
                           "min": 0.0, "max": 1.0},
                 "title": {"text": "HMM performance on classifying"
                           " weather sequences by city"},
...
class WeatherStates_all(tftask.ChartTask):
    ...
    def get_name(self):
        return "3rd Weather experiments -- which city has this weather,"
    " boston, seattle, LA, phoenix?"
    ...
    def get_description(self):
        return ("Train HMMs with different number of hidden states, and "
                "see how well they can distinguish between the weather"
                " of different cities.")
...
class BostonLikelihood(tftask.ChartTask):
    ...
    def get_description(self):
        return ("Train HMMs with different number of hidden states to "
                "see how many hidden states does boston"
                "need to model its weather.")
